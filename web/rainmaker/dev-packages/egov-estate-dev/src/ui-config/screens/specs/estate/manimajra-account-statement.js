import {
  ...
  import { MMAccountStamentApplication } from './searchResource/estateApplicationAccountStatementGen';
  import { searchResultsManimajraAccountStatement } from './searchResource/searchResultsAccountStatement';
...
import {
  ...
  const manimajraAccountStatement = {
    uiFramework: "material-ui",
    name: "manimajra-account-statement",
    ...
    components: {
      div: {
        ...
        children: {
          ...
          MMAccountStamentApplication,
          breakAfterSearch: getBreak(),
          searchResultsManimajraAccountStatement,
          downloadButton:{
            uiFramework: "custom-atoms",
            componentPath: "Container",
            props: {
  ...
  export default manimajraAccountStatement;