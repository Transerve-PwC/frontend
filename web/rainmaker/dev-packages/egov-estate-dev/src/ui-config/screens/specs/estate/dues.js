import {
  ...
  import {DuesApplication} from './dues-resource/search-dues-screen'
  ...
  const estateSearchAndResult = {
    ...
    beforeInitScreen: (action, state, dispatch) => {
      ...
      dispatch(prepareFinalObject("searchScreen", {}))
        ...
        getStatusList(action, state, dispatch, queryObject, "dues", "components.div.children.DuesApplication.children.cardContent.children.colonyContainer.children.status", "PropertyMaster")
      return action
    },
    components: {
      div: {
